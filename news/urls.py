...
urlpatterns = [
    ...
    path("article/create/", login_required(views.CreateArticleView.as_view()), name='article_create'),
    path("article/<int:pk>/edit/", login_required(views.EditArticleView.as_view()), name='article_edit'),
    path("article/<int:pk>/delete/", login_required(views.DeleteArticleView.as_view()), name='article_delete'),
    path("article/<int:pk>/", views.ArticleDetailView.as_view(), name='article_detail'),
    path("events/", views.EventListView.as_view(), name='event_list'),
    path("event/create/", login_required(views.CreateEventView.as_view()), name='event_create'),
    path("event/<int:pk>/edit/", login_required(views.EditEventView.as_view()), name='event_edit'),
    ...
    path("event/<int:pk>/delete/", login_required(views.DeleteEventView.as_view()), name='event_delete'),
    path("event/<int:pk>/", views.EventDetailView.as_view(), name='event_detail'),
    path("event/<int:event_pk>/register/", login_required(views.EventRegistrationView.as_view()), name='register_event'),
    path("timeplace/<int:pk>/edit/", login_required(views.EditTimePlaceView.as_view()), name='timeplace_edit'),
    path("timeplace/<int:pk>/duplicate/", login_required(views.DuplicateTimePlaceView.as_view()), name='timeplace_duplicate'),
    ...
    path("timeplace/<int:pk>/delete/", login_required(views.DeleteTimePlaceView.as_view()), name='timeplace_delete'),
    path("timeplace/<int:pk>/ical/", SingleTimePlaceFeed(), name='timeplace_ical'),
    path("timeplace/<int:timeplace_pk>/register/", login_required(views.EventRegistrationView.as_view()), name='register_timeplace'),
    path("ticket/<uuid:pk>/", views.TicketDetailView.as_view(), name='ticket_detail'),
    path("ticket/<uuid:pk>/cancel/", views.CancelTicketView.as_view(), name='cancel_ticket'),
