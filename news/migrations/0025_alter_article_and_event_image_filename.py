...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='article',
            name='image',
            field=models.ImageField(max_length=200, storage=util.storage.OverwriteStorage(), upload_to=functools.partial(util.storage.UploadToUtils._actual_upload_to, *(), **{'upload_to': news.models.news_subclass_directory_path}), verbose_name='Image'),
        ),
        migrations.AlterField(
            model_name='event',
            name='image',
