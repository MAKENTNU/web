...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('make_queue', '0025_reservationrule_start_days_multiselectfield'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('machine_type', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='make_queue.machinetype')),
            ],
            options={
