...
- **Moved most Django-related code to [a new top-level `src` folder](https://github.com/MAKENTNU/web/tree/main/src)**
  - _Refer to the new "PyCharm" section in the README
    (click "Click to expand" under [the "Setup" section](https://github.com/MAKENTNU/web/blob/main/README.md#setup) to make it visible)
