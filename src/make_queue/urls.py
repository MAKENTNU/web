...
from .views import (
    ...
    reservation as reservation_views,
...
specific_machinetype_urlpatterns = [
    path(
        "reservationrules/",
        reservation_rule_views.ReservationRuleListView.as_view(),
        name="reservation_rule_list",
    ),
    path(
        "usagerules/",
        machine_views.MachineUsageRuleDetailView.as_view(),
        name="machine_usage_rule_detail",
    ),
]
...
specific_reservation_urlpatterns = [
    path(
        "change/",
        login_required(reservation_views.ReservationUpdateView.as_view()),
...
reservation_urlpatterns = [
    ...
    path(
        "find-free-slots/",
        reservation_views.ReservationFindFreeSlotsView.as_view(),
        name="reservation_find_free_slots",
    ),
]
...
specific_machinetype_apipatterns = [
    path(
        "reservationrules/",
        api_views.APIReservationRuleListView.as_view(),
        name="api_reservation_rule_list",
    ),
]
...
specific_machine_apipatterns = [
    ...
    path(
        "reservations/",
        api_views.APIReservationListView.as_view(),
...
specific_reservation_apipatterns = [
    path(
        "finish/",
        api_views.APIReservationMarkFinishedView.as_view(),
        name="api_reservation_mark_finished",
    ),
    path(
        "delete/",
        api_views.APIReservationDeleteView.as_view(),
...
apipatterns = [
    ...
    path(
        "reservations/<int:pk>/",
        decorator_include(login_required, specific_reservation_apipatterns),
    ),
]
...
specific_reservation_rule_adminpatterns = [
    path(
        "change/",
        reservation_rule_views.ReservationRuleUpdateView.as_view(),
        name="reservation_rule_update",
    ),
    path(
        "delete/",
        reservation_rule_views.ReservationRuleDeleteView.as_view(),
        name="reservation_rule_delete",
    ),
]
reservation_rules_adminpatterns = [
    path(
        "add/",
        reservation_rule_views.ReservationRuleCreateView.as_view(),
        name="reservation_rule_create",
    ),
    path(
        "<int:reservation_rule_pk>/", include(specific_reservation_rule_adminpatterns)
    ),
]
specific_machinetype_adminpatterns = [
    ...
    path(
        "usagerules/change/",
        machine_views.MachineUsageRuleUpdateView.as_view(),
        name="machine_usage_rule_update",
    ),
]
...
specific_course_adminpatterns = [
    path(
        "change/",
        course_views.Printer3DCourseUpdateView.as_view(),
        name="printer_3d_course_update",
    ),
    path(
        "delete/",
        course_views.Printer3DCourseDeleteView.as_view(),
        name="printer_3d_course_delete",
    ),
]
course_adminpatterns = [
    path(
        "",
        course_views.Printer3DCourseListView.as_view(),
        name="printer_3d_course_list",
    ),
    path(
        "add/",
    ...
    path(
        ...
        name="printer_3d_course_status_bulk_update",
    ),
    path(
        "download/xlsx/",
        course_views.Printer3DCourseXLSXView.as_view(),
        name="printer_3d_course_xlsx",
    ),
]
...
quota_adminpatterns = [
    ...
    path(
        "users/<int:pk>/",
        quota_views.AdminUserQuotaListView.as_view(),
        name="admin_user_quota_list",
    ),
]
