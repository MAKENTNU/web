...
from ..test_utils import generate_all_admin_urls_for_model_and_objs, mock_module_attrs, set_without_duplicates
...
class PathTests(TestCase):
    ...
    def test__generate_all_admin_urls_for_model_and_objs__returns_as_expected(self):
        ...
        admin_urls = generate_all_admin_urls_for_model_and_objs(User, [self.user1, self.user2])
        self.assertSetEqual(set_without_duplicates(self, admin_urls), {
