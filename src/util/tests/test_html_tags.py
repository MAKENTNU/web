...
class HtmlTagTests(SimpleTestCase):
    def test__urlize_target_blank__returns_expected_html(self):
        urls_to_expected_html = {
            ...
            "example.com": (
                '<a target="_blank" href="http://example.com" rel="nofollow">'
                "example.com</a>"
            ),
            "example.com/?a=1&b=2": (
                '<a target="_blank" href="http://example.com/?a=1&b=2" rel="nofollow">'
                "example.com/?a=1&b=2</a>"
            ),
            "https://example.com/": (
                '<a target="_blank" href="https://example.com/" rel="nofollow">'
                "https://example.com/</a>"
            ),
            "https://example.com?a=1&b=2": (
                '<a target="_blank" href="https://example.com?a=1&b=2" rel="nofollow">'
