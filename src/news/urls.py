...
specific_time_place_urlpatterns = [
    path(
        "register/",
        login_required(event_views.EventTicketCreateView.as_view()),
        name="event_ticket_create",
    ),
...
specific_ticket_urlpatterns = [
    ...
    path(
        "cancel/",
        login_required(event_views.EventTicketCancelView.as_view()),
        name="event_ticket_cancel",
    ),
]
ticket_urlpatterns = [
    path("<uuid:pk>/", include(specific_ticket_urlpatterns)),
    path(
        "me/", event_views.EventTicketMyListView.as_view(), name="event_ticket_my_list"
    ),
]
...
specific_time_place_adminpatterns = [
    path(
        "change/", event_views.TimePlaceUpdateView.as_view(), name="time_place_update"
    ),
    path(
        "duplicate/",
        event_views.TimePlaceDuplicateCreateView.as_view(),
        name="time_place_duplicate_create",
    ),
    path(
        "delete/", event_views.TimePlaceDeleteView.as_view(), name="time_place_delete"
    ),
    path(
        "tickets/",
        event_views.AdminTimePlaceTicketListView.as_view(),
        name="admin_time_place_ticket_list",
    ),
]
...
specific_event_adminpatterns = [
    ...
    path(
        "tickets/",
        event_views.AdminEventTicketListView.as_view(),
        name="admin_event_ticket_list",
    ),
...
event_adminpatterns = [
    ...
    path(
        "participants/search/",
        event_views.AdminEventParticipantsSearchView.as_view(),
        name="admin_event_participants_search",
    ),
]
...
article_adminapipatterns = [
    path(
        "<int:pk>/toggle/",
        api_views.AdminAPIArticleToggleView.as_view(),
        name="admin_api_article_toggle",
    ),
]
...
specific_event_adminapipatterns = [
    path(
        "toggle/",
        api_views.AdminAPIEventToggleView.as_view(),
        name="admin_api_event_toggle",
    ),
    path(
        "timeplaces/<int:time_place_pk>/toggle/",
        api_views.AdminAPITimePlaceToggleView.as_view(),
        name="admin_api_time_place_toggle",
    ),
]
