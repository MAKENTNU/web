...
def copy_objects_from_article_and_event_to_article_tmp_and_event_tmp(
    apps, schema_editor
):
    ...
    copy_objects_from_old_model_to_new_model(
        Article, Article_Tmp, Article_Tmp._meta.fields
    )
...
def copy_objects_from_old_model_to_new_model(old_model, new_model, fields_to_copy):
    ...
    for old_obj in old_model.objects.all():
        old_obj_field_dict = {
            field_name: getattr(old_obj, field_name) for field_name in field_names
        }
        new_model.objects.create(**old_obj_field_dict)


def copy_objects_from_article_tmp_and_event_tmp_to_article_and_event(
    apps, schema_editor
):
    Article_Tmp = apps.get_model("news", "Article_Tmp")
    Event_Tmp = apps.get_model("news", "Event_Tmp")
    ...
    Event = apps.get_model("news", "Event")
    copy_objects_from_old_model_to_new_model(
        Article_Tmp, Article, Article_Tmp._meta.fields
    )
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "featured",
                    models.BooleanField(default=True, verbose_name="featured"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "number_of_tickets",
                    models.IntegerField(
                        default=0, verbose_name="number of available tickets"
                    ),
                ),
            ],
            options={
        ...
        migrations.RunPython(
            copy_objects_from_article_and_event_to_article_tmp_and_event_tmp,
        ...
        migrations.RunPython(
            migrations.RunPython.noop,
            copy_objects_from_article_tmp_and_event_tmp_to_article_and_event,
        ),
