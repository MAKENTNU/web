...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=web.modelfields.UnlimitedCharField(blank=True, validators=[django.core.validators.RegexValidator(re.compile('^(.+)#([0-9]{4})$'), 'Enter a valid Discord username - including the hashtag and the four digits at the end.')], verbose_name='Discord username'),
        ),
        migrations.AddField(
            model_name='member',
